...
const Hero = () => {
  ...
  return (
    <section
      ref={sectionRef}
      className="fade-up relative min-h-[90vh] flex items-start justify-start overflow-hidden"
    >
      {/* Fondo */}
      ...
      <div className="container mx-auto px-4 relative z-10 w-full mt-16 md:mt-24 lg:mt-32">
        <div className="max-w-2xl text-left md:transform md:translate-x-[2cm] md:translate-y-[2cm]">
          ...
          <p className="text-lg sm:text-xl md:text-2xl font-semibold text-white mt-4 font-oswald">
          ...
          <div className="mt-10 animate-float">
            <a
              ...
              className="inline-flex items-center gap-2 bg-violetaClaro hover:bg-violetaOscuro text-white font-bold py-3 px-6 rounded-full text-lg shadow-xl transition-all duration-300 hover:scale-105"
            >
